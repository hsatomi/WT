...
<%@ page import="co.jp.souya.dto.TestCaseAdminDTO" %>
<%@ page import="co.jp.souya.jpa.MovePatternAdmin" %>
<%@ page import="co.jp.souya.jpa.MovePatternDetail" %>
<%@ page import="co.jp.souya.jpa.TestCaseAdmin" %>
<html>
<head>
